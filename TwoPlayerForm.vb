Public Class TwoPlayerForm


    'Mouse'nin her haraketinde tablodaki durumu kontrol edip kazanma şartını sorgulayarak oyunu gözler '
    ...
    Private Sub TwoPlayerForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        Dim Turn As New Random
        Dim TurnResult As Integer = Turn.Next(1, 3)

        If TurnResult = 1 Then
            PlayerTurnLabel.Text = "Kırmızı Dönüş"
            PlayerTurnLabel.ForeColor = Color.Red
        End If

        If TurnResult = 2 Then
            PlayerTurnLabel.Text = "Mavi Dönüş"
            PlayerTurnLabel.ForeColor = Color.Blue
        End If

        ' Tüm Şekillerin Görünürlüğünü Kaldırır.
    ...
    Private Sub RectangleShape1_Click(sender As Object, e As EventArgs) Handles RectangleShape1.Click
        ...
        If PlayerTurnLabel.Text = "Kırmızı Dönüş" Then
            LineShape1.Visible = True
            LineShape2.Visible = True
        ElseIf PlayerTurnLabel.Text = "Mavi Dönüş" Then
